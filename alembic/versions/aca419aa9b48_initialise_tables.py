...
def upgrade() -> None:
    ...
    op.create_table('corporate_event',
    sa.Column('event_id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('symbol', sa.String(length=20), nullable=False),
    sa.Column('company_name', sa.String(length=200), nullable=True),
    sa.Column('event_type', postgresql.ENUM('RESULT', 'DIVIDEND', 'AGM', 'BONUS', 'SPLIT', 'BUYBACK', 'RIGHTS', 'OTHER', name='event_type'), nullable=False),
    ...
    op.create_index(op.f('ix_corporate_event_event_date'), 'corporate_event', ['event_date'], unique=False)
    op.create_index(op.f('ix_corporate_event_event_type'), 'corporate_event', ['event_type'], unique=False)
    op.create_index(op.f('ix_corporate_event_symbol'), 'corporate_event', ['symbol'], unique=False)
    op.create_table('external_api_request',
    ...
    op.create_index(op.f('ix_external_api_request_api_provider'), 'external_api_request', ['api_provider'], unique=False)
    op.create_index(op.f('ix_external_api_request_correlation_id'), 'external_api_request', ['correlation_id'], unique=False)
    op.create_index(op.f('ix_external_api_request_http_status_code'), 'external_api_request', ['http_status_code'], unique=False)
    op.create_index(op.f('ix_external_api_request_is_success'), 'external_api_request', ['is_success'], unique=False)
    op.create_index(op.f('ix_external_api_request_request_timestamp'), 'external_api_request', ['request_timestamp'], unique=False)
    op.create_table('fiidii',
    ...
    sa.UniqueConstraint('trade_date', 'category', 'segment', name='fiidii_trade_date_category_segment_key')
    )
    ...
    op.create_index(op.f('ix_trading_holiday_holiday_date'), 'trading_holiday', ['holiday_date'], unique=True)
    op.create_table('broker_health_log',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_table('historical_equity_data',
    sa.Column('historical_equity_data_id', sa.BigInteger(), autoincrement=True, nullable=False),
    ...
    op.create_index(op.f('ix_historical_equity_data_symbol'), 'historical_equity_data', ['symbol'], unique=False)
    op.create_index(op.f('ix_historical_equity_data_timeframe'), 'historical_equity_data', ['timeframe'], unique=False)
    op.create_index(op.f('ix_historical_equity_data_timestamp'), 'historical_equity_data', ['timestamp'], unique=False)
    op.create_table('historical_index_data',
    sa.Column('historical_index_data_id', sa.BigInteger(), autoincrement=True, nullable=False),
    sa.Column('instrument_id', sa.Integer(), nullable=False),
    sa.Column('symbol', sa.String(length=20), nullable=False),
    sa.Column('timeframe', sa.String(length=10), nullable=False),
    sa.Column('timestamp', sa.DateTime(timezone=True), nullable=False),
    ...
    sa.UniqueConstraint('symbol', 'timeframe', 'timestamp', 'index_name', name='uix_historical_index_data_key')
    )
    op.create_index(op.f('ix_historical_index_data_index_name'), 'historical_index_data', ['index_name'], unique=False)
    op.create_index(op.f('ix_historical_index_data_symbol'), 'historical_index_data', ['symbol'], unique=False)
    op.create_index(op.f('ix_historical_index_data_timeframe'), 'historical_index_data', ['timeframe'], unique=False)
    op.create_index(op.f('ix_historical_index_data_timestamp'), 'historical_index_data', ['timestamp'], unique=False)
    ...
    sa.Column('side', postgresql.ENUM('BUY', 'SELL', 'HOLD', name='order_side'), nullable=False),
    sa.Column('order_type', postgresql.ENUM('MKT', 'LMT', 'STP', 'STP_LMT', 'BRACKET', 'TRAIL', name='order_type'), nullable=False),
    ...
    sa.Column('status', postgresql.ENUM('NEW', 'PENDING', 'PARTIALLY_FILLED', 'FILLED', 'CANCELLED', 'REJECTED', name='order_status'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['broker_id'], ['broker.broker_id'], ),
    sa.ForeignKeyConstraint(['instrument_id'], ['instrument.instrument_id'], ),
    sa.ForeignKeyConstraint(['parent_order_id'], ['trading_order.order_id'], ),
    ...
    sa.Column('action', postgresql.ENUM('BUY', 'SELL', 'EXIT', name='signal_action'), nullable=False),
    sa.Column('timeframe', postgresql.ENUM('SCALPING', 'INTRADAY', 'SWING', 'POSITIONAL', name='signal_timeframe'), nullable=False),
    ...
    sa.Column('status', postgresql.ENUM('OPEN', 'CLOSED', name='trade_status'), nullable=True),
    sa.ForeignKeyConstraint(['broker_id'], ['broker.broker_id'], ),
    sa.ForeignKeyConstraint(['entry_order_id'], ['trading_order.order_id'], ),
    sa.ForeignKeyConstraint(['exit_order_id'], ['trading_order.order_id'], ),
    sa.ForeignKeyConstraint(['instrument_id'], ['instrument.instrument_id'], ),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_external_api_request_request_timestamp'), table_name='external_api_request')
    op.drop_index(op.f('ix_external_api_request_is_success'), table_name='external_api_request')
    op.drop_index(op.f('ix_external_api_request_http_status_code'), table_name='external_api_request')
    op.drop_index(op.f('ix_external_api_request_correlation_id'), table_name='external_api_request')
